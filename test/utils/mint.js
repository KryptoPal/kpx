...
exports.test = function(web3, accounts, token) {
  describe('minting', function() {
    it(`should mint 10 ${token.symbol} for ${utils.formatAccount(
      accounts[1]
    )}`, async function() {
    ...
    it(
      `should mint 10 ${token.symbol} for ` +
        `${utils.formatAccount(accounts[1])} (ERC20 disabled)`,
      async function() {
        await utils.assertBalance(web3, token, accounts[1], 0);
